...
export const colors = {
  ...
  redWt: lighten(0.22, '#bc1a1a'),
  redHL: lighten(0.165, '#bc1a1a'),
  redLt: lighten(0.11, '#bc1a1a'),
  redLLt: lighten(0.055, '#bc1a1a'),
  redM: '#bc1a1a',
  redHD: darken(0.055, '#bc1a1a'),
  redD: darken(0.11, '#bc1a1a'),
  redLD: darken(0.165, '#bc1a1a'),
  redBlk: darken(0.22, '#bc1a1a'),
